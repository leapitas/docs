...
3. Upload the `.app` file provided by Leap IT
4. Select the language and click **Deploy**

Once installed, the extension is active and the **Freja Setup** page will be available for configuration.
