...
- **Compliant with PEPPOL 3.0**: Validation of invoice format according to Norwegian requirements, including support for KID number
- **Status and receipts**: Keep track of transmitted messages with real-time updates of status and receipts
- **Multichannel**: Invoice distribution through various channels
- **Business Central integration**: Fully integrated with Business Central's standard functionality for e-document management
- **Lookup against Peppol Directory**: With lookup against PEPPOL Directory, the system can verify that the recipient is connected to the PEPPOL network
